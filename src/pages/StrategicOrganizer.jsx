      ...
      <Dialog open={showPreview} onOpenChange={setShowPreview}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-gray-50">
          <div className="space-y-6 text-sm">
            {/* Header */}
            <div className="bg-blue-900 text-white p-6 rounded-lg -m-6 mb-6">
              <h1 className="text-3xl font-bold mb-2">{schoolName || "School Name"}</h1>
              <p className="text-blue-100 text-sm">STRATEGIC ORGANIZER</p>
              <p className="text-blue-200 text-xs mt-2">Academy Compass — Always know where your business is headed.</p>
            </div>

            {/* Foundation Section */}
            <div>
              <div className="bg-blue-900 text-white px-6 py-3 font-semibold text-sm tracking-wide">FOUNDATION</div>
              <div className="grid grid-cols-2 gap-6 p-6 bg-white border border-gray-200">
                <div>
                  <p className="text-xs font-semibold text-blue-700 mb-2 uppercase">Mission</p>
                  <p className="text-sm leading-relaxed">{mission || "N/A"}</p>
                  <div className="mt-4 space-y-2">
                    <p className="text-xs font-semibold text-blue-700 uppercase">Core Values</p>
                ...
                <div>
                  <p className="text-xs font-semibold text-amber-700 mb-2 uppercase">BHAG (BIG HAIRY AUDACIOUS GOAL)</p>
                  <p className="text-sm leading-relaxed mb-4">{bhag || "N/A"}</p>
                  <div>
                    <p className="text-xs font-semibold text-blue-700 mb-2 uppercase">Ideal Customer Profile</p>
                    <p className="text-xs leading-relaxed">{icp || "N/A"}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="bg-blue-900 text-white px-6 py-3 font-semibold text-sm tracking-wide">VISION & GOALS</div>
              <div className="space-y-6 p-6 bg-white border border-gray-200">
                {/* 3 Year Vision */}
                <div className="pb-6 border-b border-gray-200">
                  <p className="text-xs font-semibold text-blue-700 uppercase mb-3">3 Year Vision</p>
                  <div className="grid grid-cols-4 gap-4 mb-4">
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Due</p>
                      <p className="text-sm font-semibold text-blue-900">{threeYear?.target_date || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Revenue</p>
                      <p className="text-sm font-semibold text-blue-900">{threeYear?.revenue_target || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Students</p>
                      <p className="text-sm font-semibold text-blue-900">{threeYear?.student_target || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Net Profit</p>
                      <p className="text-sm font-semibold text-blue-900">{threeYear?.net_profit_target || "N/A"}</p>
                    </div>
                  </div>
                ...
                {/* 1 Year Goal */}
                <div className="pb-6 border-b border-gray-200">
                  <p className="text-xs font-semibold text-blue-700 uppercase mb-3">1 Year Goal</p>
                  <div className="grid grid-cols-4 gap-4 mb-4">
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Due</p>
                      <p className="text-sm font-semibold text-blue-900">{oneYear?.target_date || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Revenue</p>
                      <p className="text-sm font-semibold text-blue-900">{oneYear?.revenue_target || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Students</p>
                      <p className="text-sm font-semibold text-blue-900">{oneYear?.student_target || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Net Profit</p>
                      <p className="text-sm font-semibold text-blue-900">{oneYear?.net_profit_target || "N/A"}</p>
                    </div>
                  </div>
                ...
                {/* 90 Day Projects */}
                <div>
                  <p className="text-xs font-semibold text-orange-700 uppercase mb-3">90 Day Projects</p>
                  <div className="grid grid-cols-4 gap-4 mb-4">
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Due</p>
                      <p className="text-sm font-semibold text-blue-900">{ninetyDay?.target_date || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Revenue</p>
                      <p className="text-sm font-semibold text-blue-900">{ninetyDay?.revenue_target || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Students</p>
                      <p className="text-sm font-semibold text-blue-900">{ninetyDay?.student_target || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Net Profit</p>
                      <p className="text-sm font-semibold text-blue-900">{ninetyDay?.net_profit_target || "N/A"}</p>
                    </div>
                  </div>
            ...
            {/* Capture Section */}
            <div>
              <div className="bg-green-800 text-white px-6 py-3 font-semibold text-sm tracking-wide">CAPTURE</div>
              <div className="grid grid-cols-2 gap-6 p-6 bg-white border border-gray-200">
                <div>
                  <p className="text-xs font-semibold text-green-700 mb-2 uppercase">The Parking Lot</p>
                ...
                <div>
                  <p className="text-xs font-semibold text-green-700 mb-2 uppercase">Focus of the Year</p>
                  <p className="text-xs leading-relaxed">{focusOfYear || "N/A"}</p>
                </div>
              </div>
            </div>
