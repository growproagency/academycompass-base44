          ...
          <div className="flex items-center gap-3 mb-1">
            <div style={{ width: 36, height: 36, overflow: "hidden", flexShrink: 0 }}>
              <img
                ...
                alt="Grow Pro"
                style={{ width: 200, height: 140, objectFit: "cover", objectPosition: "8% 46%", mixBlendMode: "screen", marginTop: -52, marginLeft: -2 }}
              />
            </div>
          ...
          <div className="flex items-center gap-2">
            <div style={{ width: 24, height: 24, overflow: "hidden", flexShrink: 0 }}>
              <img
                src="https://media.base44.com/images/public/69b2f65ec8ee0dde1fce1074/3c5268561_GrowProAgencyLogo_Darkcopy.png"
                alt="Grow Pro"
                style={{ width: 133, height: 93, objectFit: "cover", objectPosition: "14% 46%", marginTop: -34, marginLeft: -2 }}
              />
            </div>
